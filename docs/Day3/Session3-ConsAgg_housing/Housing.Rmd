...
- Different approaches to input housing flow of service
...
- Welfare measure (i.e., expenditure) must be consistent across households in order to make comparisons among themselves
...
## Different approaches to input housing flow of service (i.e., imputing rent)
...
### .blue[Econometric and statistical methods]
...
- use information about the out-of-pocket expenditure faced by households. **For owners** it would be the mortgage, interest payments, taxes, insurance, maintenance and repairs. 
  
---
### External sources

- Other household surveys, administrative register, newspaper or internet offer notices, multiple listing datasets, mortgage transactions, key informant evaluations. 
...
- A plausible solution is to implement a Heckman two-stages selection model,
...
- Effects when poverty lines is adjusted

---
### Fixed poverty line
```{r Fixed_povline,  fig.align='left',  echo=FALSE}
knitr::include_graphics('./img/Fixed_povline.png')
```

---
### Fixed poverty line, by regions

```{r Fixed_povline2,  fig.align='left',  echo=FALSE}
knitr::include_graphics('./img/Fixed_povline2.png')
```

---
### Adjusted poverty lines
```{r adj_povline,  fig.align='left',  echo=FALSE}
knitr::include_graphics('./img/adj_povline.png')
```
...
---
class: center
![thank_you](https://media.giphy.com/media/10dvjmLNHQ6O3e/giphy.gif)
