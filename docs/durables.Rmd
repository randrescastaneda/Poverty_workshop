...
- **Nominal interest rate** $(i_t)$: There are many options. The most common are:
  - Interest rate on safe assets like yeilds of governmnet bonds (If one assumes that risk aversion and wealth are negatively correlate (Arrow 1971) ). 
...
In general, the relationship between the price in $t$ of thea  good $v$-year old, $(p_{v,t})$, and its market value as new, $(p_{0,t})$, may be discribed as, 
